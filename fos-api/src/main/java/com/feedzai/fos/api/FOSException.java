...
/**
 * All FOS related functionality will throw a FOS exception if it fails to achieve the contract.
 * If the failure was caused by some other underlying exception, FOSException will contain that exception
 */
