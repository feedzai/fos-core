...
/**
 * Factory for creating classifiers (managers).
 * Must be extended by implementations of the API.
 *
 *  @author Marco Jorge (marco.jorge@feedzai.com)
 */
public interface ManagerFactory<U extends Manager> {
    /**
     ...
     * @return a new manager every time
     */
    @NotNull
    U createManager(FosConfig configuration) throws FOSException;
}
